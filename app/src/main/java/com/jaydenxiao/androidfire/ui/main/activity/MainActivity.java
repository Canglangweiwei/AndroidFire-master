...
public class MainActivity extends BaseActivity {
    ...
    public static void startAction(Activity activity) {
        ...
        activity.overridePendingTransition(R.anim.fade_in, com.jaydenxiao.common.R.anim.fade_out);
    }
...
//      UpdateKey.DialogOrNotification = UpdateKey.WITH_DIALOG;
        ...
        switch (index) {
            case 0:
                ...
                if (newsMainFragment == null) {
                    ...
                    transaction.add(R.id.fl_body, newsMainFragment);
                } else {
            ...
            case 1:
                /** 美女 */
                if (photosMainFragment == null) {
                    photosMainFragment = new PhotosMainFragment();
                    transaction.add(R.id.fl_body, photosMainFragment);
                } else {
            ...
            case 2:
                ...
                if (videoMainFragment == null) {
                    ...
                    transaction.add(R.id.fl_body, videoMainFragment);
                } else {
            ...
            case 3:
                ...
                if (careMainFragment == null) {
                    ...
                    transaction.add(R.id.fl_body, careMainFragment);
                } else {
    ...
    private void initFragment() {
        ...
        addFragmentToStack(currentTabPosition);
